...
<p>Cell dimensions and membrane capacitance were assumed in line with experimental data, adopting dimensions of intracellular compartments from the parent model. [<a href="#ref2">2</a>]</p>
...
<p>Overall, the model by Fabbri et al. [<a href="#ref1">1</a>] integrates detailed revisions to accurately represent human SAN cells, reflecting experimental data, and making specific modifications to currents, capacitance, Ca<sup>2+</sup> handling, and ion concentrations.</p>

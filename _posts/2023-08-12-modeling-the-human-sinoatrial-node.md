...
2. [Model Foundation](#2-model-foundation)
   - [Membrane Potential Dynamics in the Human SAN Model](#21-membrane-potential-dynamics-in-the-human-san-model)
   - [Understanding Ion Channel Dynamics: A Look at the Hodgkin-Huxley Model](#22-understanding-ion-channel-dynamics-a-look-at-the-hodgkin-huxley-model)
   - [Cell Capacitance and Dimensions](#23-cell-capacitance-and-dimensions)
   - [Membrane Currents](#24-membrane-currents)
   - [Calcium Handling](#25-calcium-handling)
   - [Ion Concentrations](#26-ion-concentrations)
   - [Autonomic Modulation of the Sinoatrial Node](#27-autonomic-modulation-of-the-sinoatrial-node)
   - [Action Potential Waveform](#28-action-potential-waveform)
...
5. [Understanding the Structure of the Generated Python Code](#5-understanding-the-structure-of-the-generated-python-code)
   - [Size Definitions and Imports](#51-size-definitions-and-imports)
   - [Create Legends and Labels](#52-create-legends-and-labels)
   - [Initialize Constants and States](#53-initialize-constants-and-states)
   - [Compute Rates](#54-compute-rates)
   - [Compute Algebraic Variables](#55-compute-algebraic-variables)
   - [Piecewise Function](#56-piecewise-function)
   - [Solve the Model](#57-solve-the-model)
   - [Plot the Results](#58-plot-the-results)
   - [Main Execution](#59-main-execution)
6. [Code Modifications](#6-code-modifications)
   - [Definition of Sinoatrial Node Class](#61-definition-of-sinoatrial-node-class)
   - [Refactoring for Better Readability](#62-refactoring-for-better-readability)
   - [Introduction of Update Function](#63-introduction-of-update-function)
   - [Constructor for Initialization](#64-constructor-for-initialization)
   - [Step Function for Calculating Rates](#65-step-function-for-calculating-rates)
   - [Conversion of Piecewise Terms to Use NumPy](#66-conversion-of-piecewise-terms-to-use-numpy)
   - [Executing the Simulation with solve_ivp](#67-executing-the-simulation-with-solveivp)
   - [Plotting the Results](#68-plotting-the-results)
